                                        ...
                                        <tr>
                                            <td width="50%" valign="top" style="padding: 6px;">
                                                <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="background: #FFFFFF; border: 1px solid #E4E2DC; border-radius: 8px;">
                                                    ...
                                                    <tr><td style="padding: 0 12px 12px; font-family: Montserrat, Arial, sans-serif; font-size: 18px; line-height: 1.2; color: #0A0A0A; font-weight: 800;"><?php echo e($order->updated_at->format('M d, Y')); ?></td></tr>
                                                </table>
                                            </td>
                                            <td width="50%" valign="top" style="padding: 6px;">
                                                <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="background: #FFFFFF; border: 1px solid #E4E2DC; border-radius: 8px;">
                                                    ...
                                                    <tr><td style="padding: 0 12px 12px; font-family: Montserrat, Arial, sans-serif; font-size: 18px; line-height: 1.2; color: #0A0A0A; font-weight: 800;"><?php echo e(ucfirst($order->payment_method)); ?></td></tr>
                                                </table>
                                            </td>
                                        </tr>
                                    </table>
                        ...
                        <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="margin-top: 20px;">
                            <tr>
                                <td align="center" style="padding-bottom: 10px;">
                                    <a href="<?php echo e(route('profile.orders.receipt', $order->id)); ?>" style="display: inline-block; background: #0A0A0A; color: #FFFFFF; text-decoration: none; font-family: Montserrat, Arial, sans-serif; font-size: 12px; font-weight: 800; text-transform: uppercase; letter-spacing: 1px; padding: 13px 22px; border-radius: 8px;">
                                        Download Receipt
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                <td align="center">
                                    <a href="<?php echo e(route('profile.orders.show', $order->id)); ?>" style="display: inline-block; color: #3A3A3A; text-decoration: none; font-family: Montserrat, Arial, sans-serif; font-size: 11px; font-weight: 700; letter-spacing: 0.6px; text-transform: uppercase;">
                                        View Order Details
                                    </a>
                                </td>
                            </tr>
                ...
                <tr>
                    <td style="padding: 16px 24px 22px; border-top: 1px solid #ece8df; background-color: #FFFFFF;">
                        <p style="margin: 0; text-align: center; font-family: Inter, Arial, sans-serif; font-size: 12px; line-height: 1.7; color: #999994;">
                            &copy; <?php echo e(date('Y')); ?> SoleMates Footwear. Crafted for comfort, designed for style.
                        </p>
                    </td>
                </tr>
            </table>
...
<?php echo $__env->make('layouts.email', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp_ITCP226\htdocs\SoulMates-Inc-Project\resources\views/emails/orders/thank-you-simple.blade.php ENDPATH**/ ?>