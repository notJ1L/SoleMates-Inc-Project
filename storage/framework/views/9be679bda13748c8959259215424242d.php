<?php $__env->startSection('title', 'Register — SoleMates Footwear'); ?>
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input id="address" type="text" 
                                   class="form-control border-start-0 <?php $__errorArgs = ['address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="text-center">
                    <p class="mb-0">Already have an account? 
                        <a href="<?php echo e(route('login')); ?>" class="text-decoration-none fw-semibold">
                            Sign in here
                        </a>
                    </p>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp_ITCP226\htdocs\SoleMates Inc\resources\views/auth/register.blade.php ENDPATH**/ ?>