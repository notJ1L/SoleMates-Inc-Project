...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'SoulMates Footwear'); ?></title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        <div class="container">
            <a class="navbar-brand fw-bold" href="<?php echo e(route('home')); ?>">
                <i class="fas fa-shoe-prints me-2"></i>SoulMates Footwear
            </a>
    ...
    <footer class="bg-dark text-light py-4 mt-5">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <h5><i class="fas fa-shoe-prints me-2"></i>SoulMates Footwear</h5>
            ...
            <div class="text-center">
                <p>&copy; <?php echo e(date('Y')); ?> SoulMates Footwear. All rights reserved.</p>
            </div>
        </div>
    </footer>
...
<?php /**PATH C:\xampp_system\htdocs\SoulMates-Inc-Project\resources\views/layouts/app.blade.php ENDPATH**/ ?>