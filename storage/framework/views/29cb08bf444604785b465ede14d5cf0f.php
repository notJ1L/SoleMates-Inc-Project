<?php $__env->startSection('title', 'Confirm Password — SoleMates Footwear'); ?>
...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .auth-security-badge-text strong {
    display: block;
  ...
  .auth-forgot-link:hover { color: var(--c-black); }
  ...
  @media (max-width: 960px) {
    ...
    .auth-visual-subtext,
    .auth-security-badge { display: none; }
...
<div class="auth-page">
  ...
  <aside class="auth-visual">
    <div class="auth-visual-inner">
      ...
      <div class="auth-visual-body">
        <span class="auth-visual-kicker">Security Checkpoint</span>

        <h1 class="auth-visual-headline">
          Just making
          <span class="line-gold">sure it's you.</span>
        </h1>

        <p class="auth-visual-subtext">
          Before you continue to this sensitive area of your account,
          please confirm your current password. This keeps your account
          safe from unauthorised changes.
        </p>

        <div class="auth-security-badge" aria-hidden="true">
          <div class="auth-security-badge-icon">
            <i class="fas fa-shield-alt"></i>
          </div>
          <div class="auth-security-badge-text">
            <strong>Your account is protected</strong>
            This is a one-time verification step for sensitive actions.
          </div>
        </div>
      </div>
  ...
  <section class="auth-form-panel" aria-label="Confirm password form">

    <header class="auth-form-header">
      <p class="auth-form-eyebrow">Verification Required</p>
    ...
    <div class="auth-notice" role="note">
      ...
      <span>
        This area requires password confirmation for your security.
        You won't be asked again for the next 3 hours.
      </span>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp2\htdocs\SoulMates-Inc-Project\resources\views\auth\passwords\confirm.blade.php ENDPATH**/ ?>