...
<head>
    <meta charset="utf-8">
    <title>Order Receipt - <?php echo e($orderNumber); ?></title>
    <style>
            ...
            <table class="info-table">
                <tr>
                    <td class="info-cell">
                        ...
                        <div class="info-value"><?php echo e($orderDate); ?></div>
                    </td>
                    <td class="info-cell">
                        <div class="info-label">Payment Method</div>
                        <div class="info-value"><?php echo e(ucfirst(str_replace('_', ' ', $order->payment_method))); ?></div>
                    </td>
                </tr>
                <tr>
                    <td class="info-cell">
                        <div class="info-label">Payment Status</div>
                        <div class="info-value"><?php echo e(ucfirst($order->payment_status)); ?></div>
                    </td>
                    <td class="info-cell">
                        <div class="info-label">Order Status</div>
                        <div class="info-value"><?php echo e(ucfirst($order->status)); ?></div>
                    </td>
                </tr>
            </table>
        </div>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            ...
                            <div class="product-brand"><?php echo e($item->product->brand->name ?? ''); ?></div>
                        </td>
                        <td class="td-center"><?php echo e($item->quantity); ?></td>
                        <td class="td-right">P<?php echo e(number_format($item->price, 2)); ?></td>
                        <td class="td-right">P<?php echo e(number_format($item->subtotal, 2)); ?></td>
                    </tr>
            ...
            <div class="totals-box">
                <table class="totals-table">
                    <tr>
                        ...
                        <td class="val">P<?php echo e(number_format($subtotal, 2)); ?></td>
                    </tr>
                    <tr>
                        <td class="lbl">Shipping</td>
                        <td class="val">P<?php echo e(number_format($shipping, 2)); ?></td>
                    </tr>
                    <tr class="grand">
                        <td class="lbl">Total</td>
                        <td class="val">P<?php echo e(number_format($total, 2)); ?></td>
                    </tr>
                </table>
            </div>
        </div>
...
<?php /**PATH C:\xampp2\htdocs\SoulMates-Inc-Project\resources\views/pdfs/order-receipt.blade.php ENDPATH**/ ?>