                            ...
                            <?php if($oldStatus && $oldStatus !== $order->status): ?>
                                <tr>
                                    <td align="center" style="padding: 0 16px 16px; font-family: Inter, Arial, sans-serif; font-size: 13px; color: rgba(255,255,255,0.8);">
                                        <span style="text-decoration: line-through; color: rgba(255,255,255,0.45);"><?php echo e(ucfirst($oldStatus)); ?></span>
                                        <span style="display:inline-block; margin: 0 7px; color: #C8A96E;">&rarr;</span>
                                        <span style="font-weight: 700; color: #FFFFFF;"><?php echo e(ucfirst($order->status)); ?></span>
                                    </td>
                                </tr>
                            <?php endif; ?>
                        </table>
                                        ...
                                        <tr>
                                            ...
                                            <td width="50%" valign="top" style="padding: 6px;">
                                                <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="background: #FFFFFF; border: 1px solid #E4E2DC; border-radius: 8px;">
                                                    ...
                                                    <tr><td style="padding: 0 12px 12px; font-family: Montserrat, Arial, sans-serif; font-size: 18px; line-height: 1.2; color: #0A0A0A; font-weight: 800;"><?php echo e($order->updated_at->format('M d, Y H:i')); ?></td></tr>
                                                </table>
                                            </td>
                                        </tr>
                                    </table>
...
<?php echo $__env->make('layouts.email', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp_ITCP226\htdocs\SoulMates-Inc-Project\resources\views/emails/orders/status-updated.blade.php ENDPATH**/ ?>