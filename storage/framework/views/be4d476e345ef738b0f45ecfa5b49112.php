...
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: white; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.08);">
    ...
    <div style="padding: 40px 30px;">
        <p style="font-size: 16px; margin-bottom: 20px;">Hi <?php echo e($user->name); ?>,</p>
        ...
        <div style="background: #f8f5f1; border-radius: 8px; padding: 20px; margin: 25px 0; border-left: 4px solid #C8A96E;">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                ...
                <div style="padding: 12px; background: white; border-radius: 6px; border: 1px solid #e6e0d8;">
                    ...
                    <div style="font-size: 16px; font-weight: 600; color: #0C0C0C;"><?php echo e(ucfirst($order->payment_status)); ?></div>
                </div>
                <div style="padding: 12px; background: white; border-radius: 6px; border: 1px solid #e6e0d8;">
                    <div style="font-size: 12px; color: #6B6560; text-transform: uppercase; letter-spacing: 0.3px; margin-bottom: 4px;">Order Date</div>
                    <div style="font-size: 16px; font-weight: 600; color: #0C0C0C;"><?php echo e($order->created_at->format('M d, Y')); ?></div>
                </div>
            </div>
        </div>
        ...
        <div style="text-align: center;">
            <a href="<?php echo e(route('profile.orders.show', $order->id)); ?>" style="display: inline-block; background: #C8A96E; color: #0C0C0C; padding: 14px 28px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 16px;">View Order Details</a>
        </div>
...
<?php echo $__env->make('layouts.email', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp2\htdocs\SoulMates-Inc-Project\resources\views/emails/orders/completed-simple.blade.php ENDPATH**/ ?>