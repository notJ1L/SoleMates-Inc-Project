<?php $__env->startSection('title', $product->name . ' — SoulMates Inc.'); ?>
    ...
    <div class="row g-5">
        ...
        <div class="col-lg-5">
            <div class="product-gallery">
                ...
                <?php if($product->photos && $product->photos->count() > 1): ?>
                    <div class="thumb-strip">
                        <?php $__currentLoopData = $product->photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="thumb <?php echo e($i === 0 ? 'active' : ''); ?>"
                                 onclick="switchPhoto(this, '<?php echo e(asset('product_photos/' . $photo->image_path)); ?>')">
                                <img src="<?php echo e(asset('product_photos/' . $photo->image_path)); ?>" alt="">
                            </div>
        ...
        <div class="col-lg-7">
            <div class="product-detail-brand"><?php echo e($product->brand); ?></div>
            ...
            <div class="product-meta">
                ...
                <div class="meta-row">
                    ...
                    <a href="<?php echo e(route('products.index')); ?>?category=<?php echo e(urlencode($product->category)); ?>"
                       style="color:var(--accent); text-decoration:none;"><?php echo e($product->category); ?></a>
                </div>
                <?php endif; ?>
                <?php if($product->size): ?>
                <div class="meta-row">
            ...
            <div class="col-6 col-md-3">
                <a href="<?php echo e(route('products.show', $related->id)); ?>" class="related-card">
                    <div class="related-img">
                        <?php if($related->photos && $related->photos->first()): ?>
                            <img src="<?php echo e(asset('product_photos/' . $related->photos->first()->image_path)); ?>" alt="<?php echo e($related->name); ?>">
                        <?php else: ?>
