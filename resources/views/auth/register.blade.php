...
@section('title', 'Create Account — SoleMates Footwear')
        ...
        <div class="form-field">
          ...
          <div class="field-wrap">
            ...
            <input
              ...
              aria-required="true"
              aria-describedby="pwd-meter-label {{ $errors->has('password') ? 'pwd-error' : '' }}"
            >
            <button
              type="button"
              class="btn-eye"
        ...
        <div class="form-field">
          ...
          <div class="field-wrap">
            ...
            <input
              ...
              aria-required="true"
              aria-describedby="confirm-match {{ $errors->has('password_confirmation') ? 'confirm-error' : '' }}"
            >
            <button
              type="button"
              class="btn-eye"
