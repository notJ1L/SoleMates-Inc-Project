            ...
            <div class="co-card-body">
              <div class="row g-3">
                <div class="col-md-6">
                  ...
                  <input type="text" id="co_name" class="co-input" value="{{ $user->name }}" readonly aria-label="Full name (auto-filled)">
                </div>
                <div class="col-md-6">
                  <label class="co-label" for="co_email">Email Address</label>
                  <input type="email" id="co_email" class="co-input" value="{{ $user->email }}" readonly aria-label="Email (auto-filled)">
                </div>
                <div class="col-12">
                  <label class="co-label" for="phone">Phone Number <span style="color:#C0392B;">*</span></label>
                  <input type="tel" id="phone" name="phone"
                         class="co-input {{ $errors->has('phone') ? 'is-invalid' : '' }}"
                         value="{{ old('phone', $user->phone) }}"
                         placeholder="+63 912 345 6789"
                         required
                         aria-required="true">
                  @error('phone')
                    <p class="co-feedback" role="alert">{{ $message }}</p>
                  @enderror
                </div>
                <div class="col-12">
                  <label class="co-label" for="shipping_address">Shipping Address <span style="color:#C0392B;">*</span></label>
                  <textarea id="shipping_address" name="shipping_address"
                            class="co-input co-textarea {{ $errors->has('shipping_address') ? 'is-invalid' : '' }}"
                            placeholder="House/Unit no., Street, Barangay, City, Province"
                            required
                            aria-required="true">{{ old('shipping_address', $user->address) }}</textarea>
          ...
          <div class="co-card" data-reveal="up" data-delay="2">
            ...
            <div class="co-card-body">
              @error('payment_method')
                <p class="co-feedback mb-3" role="alert">{{ $message }}</p>
              @enderror
            ...
            <div class="co-summary-body">
              ...
              @foreach($cart as $productId => $item)
                <div class="co-order-item">
                  ...
                  <div style="flex:1;min-width:0;">
                    ...
                    <div class="co-order-meta">Qty: {{ $item['quantity'] }}</div>
                  </div>
                  <div class="co-order-price">&#8369;{{ number_format($item['price'] * $item['quantity'], 2) }}</div>
                </div>
              @endforeach
              ...
              <div class="co-totals">
                ...
                <div class="co-grand-total">
                  ...
                  <span class="co-grand-amount">&#8369;{{ number_format($cartTotal, 2) }}</span>
                </div>
              </div>
