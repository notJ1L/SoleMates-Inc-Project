        ...
        <table class="order-strip-table">
            <tr>
                <td style="width: 36%; vertical-align: top;">
                    ...
                    <div class="os-val">{{ $orderNumber }}</div>
                </td>
                <td style="width: 30%; vertical-align: top;">
                    <div class="os-label">Date Issued</div>
                    <div class="os-val">{{ $orderDate }}</div>
                </td>
            ...
            <table class="detail-table">
                <tr class="detail-row">
                    <td class="dt-left">
                        ...
                        <div class="dt-val">{{ $user->name }}</div>
                    </td>
                    <td class="dt-right">
                        <div class="dt-label">Email Address</div>
                        <div class="dt-val">{{ $user->email }}</div>
                    </td>
                </tr>
                <tr class="detail-row">
                    <td class="dt-left">
                        <div class="dt-label">Phone Number</div>
                        <div class="dt-val">{{ $order->phone }}</div>
                    </td>
                    <td class="dt-right">
                        <div class="dt-label">Shipping Address</div>
                        <div class="dt-val">{{ $order->shipping_address }}</div>
                    </td>
                </tr>
            </table>
        </div>
            ...
            <table class="detail-table">
                <tr class="detail-row">
                    <td class="dt-left">
                        ...
                        <div class="dt-val">{{ ucfirst(str_replace('_', ' ', $order->payment_method)) }}</div>
                    </td>
                    <td class="dt-right">
        ...
        <table class="items-table">
            ...
            <tr class="items-body">
                <td>
                    ...
                    <div class="item-sub">{{ $item->product->brand->name ?? 'SoleMates' }} &nbsp;&#183;&nbsp; Sneakers</div>
                </td>
                <td style="text-align: center;">
                    <span class="qty-chip">{{ $item->quantity }}</span>
                </td>
                <td style="text-align: right; color: #9A9486;">&#8369;{{ number_format($item->price, 2) }}</td>
                ...
                <td class="totals-col">
                    <table style="width: 100%; border-collapse: collapse;">
                        <tr class="totals-row">
                            ...
                            <td class="t-val">&#8369;{{ number_format($subtotal, 2) }}</td>
                        </tr>
                        <tr class="totals-row">
                        ...
                        <tr class="total-final-row">
                            ...
                            <td class="total-final-val">&#8369;{{ number_format($total, 2) }}</td>
                        </tr>
                    </table>
                </td>
            </tr>
