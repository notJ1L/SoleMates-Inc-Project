...
@section('title', 'About Us — SoleMates Footwear')
    ...
    <div class="row align-items-center g-5">
      ...
      <div class="col-lg-7 order-lg-1">
        ...
        <div class="d-flex flex-wrap gap-3 mt-4">
          <a href="{{ route('products.index') }}" class="btn btn-dark px-4 py-2" style="font-family:'Montserrat',sans-serif;font-size:0.82rem;font-weight:700;letter-spacing:0.07em;text-transform:uppercase;border-radius:8px;">
      ...
      <div class="mission-inner">
        <div class="row align-items-center g-4">
          ...
          <div class="col-lg-4 text-lg-end">
            <a href="{{ route('products.index') }}" class="btn-mission">
              Shop Now
