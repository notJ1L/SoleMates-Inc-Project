...
@section('title', 'My Cart — SoleMates Footwear')
  ...
  <div class="container">
    ...
    @if(empty($cart))
      ...
      <div class="cart-empty" data-reveal="scale">
        ...
        <a href="{{ route('products.index') }}" class="btn-checkout d-inline-flex" style="width:auto;padding:13px 28px;">
      ...
      <div class="row g-4">
        ...
        <div class="col-lg-8">
          ...
          @foreach($cart as $productId => $item)
            <div class="cart-item-wrap" data-reveal="up" data-delay="{{ $loop->index + 1 }}">
              <div class="cart-item">
                ...
                {{-- Qty + Update --}}
                <form action="{{ route('cart.update') }}" method="POST" id="form-qty-{{ $productId }}">
                  @csrf
                  @method('PUT')
                  ...
                  <div class="qty-group">
                    ...
                    <input type="number"
                           ...
                           min="1"
                           max="{{ $item['stock'] }}"
                           onchange="document.getElementById('form-qty-{{ $productId }}').submit()"
                ...
                <form action="{{ route('cart.remove', $productId) }}" method="POST">
                  ...
                  <button type="submit"
                          class="btn-remove"
                          onclick="return confirm('Remove {{ addslashes($item['name']) }} from your cart?')"
